...
/////
/////    APCA is licensed to the W3 on a limited basis for predicting the
/////    contrast of WEB CONTENT only — which is exactly this tool's purpose.
/////
/////    VENDORED into this repository, verbatim, from the apca-w3 npm package
/////    version 0.1.9. Only the two functions this tool calls — APCAcontrast()
/////    and sRGBtoY() — are included; the G-4g constants are UNMODIFIED, as
/////    the licence requires. Vendoring avoids apca-w3's transitive dependency
/////    `colorparsley` (AGPL v3): this project never needs a colour-string
/////    parser because colours are always parsed from hex by core/contrast.js.
/////
/////    "Keep current" clause: if APCA publishes updated constants, refresh
/////    this file from https://github.com/Myndex/apca-w3 to stay compliant.
/////
...
/**
 * APCA perceptual-contrast math, vendored verbatim from apca-w3 0.1.9.
